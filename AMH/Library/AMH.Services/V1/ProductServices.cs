...
namespace AMH.Services.V1
{
    public class ProductServices : AbstractProductServices
    {
        ...
        public override PagedList<AbstractProduct> Product_All(PageParam pageParam, string search,int IsVisibleAll, int Cat_Id,int Users_Id)
        {
            return this.abstractProductDao.Product_All(pageParam, search, IsVisibleAll, Cat_Id, Users_Id);
        }
