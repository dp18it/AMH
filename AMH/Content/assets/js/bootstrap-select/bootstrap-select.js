    ...
    createView: function (isSearching, setSize, refresh) {
      ...
      function scroll (scrollTop, init) {
        ...
        if (init || positionIsDifferent) {
          ...
          // if searching, check to make sure the list has actually been updated before uptopfarms DOM
    ...
    buildList: function () {
      ...
      function buildElement (item) {
        ...
        if (combinedLength > widestOptionLength) {
          ...
          // not perfect, but it's fast, and the width will be uptopfarms accordingly when scrolling
