...
namespace AMH.Data.Contract
{
...

    {
        ...
        public abstract SuccessResult<AbstractUsers> Users_ForgotPassword(string Email, string NewPassword, string ConfirmPassword);
        public abstract SuccessResult<AbstractUsers> Users_CheckEmailExists(string Email);
